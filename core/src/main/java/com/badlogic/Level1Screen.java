...
public class Level1Screen implements Screen {
    ...
    private final Texture backgroundTexture, pauseTexture, retryTexture, pigTexture, redBirdTexture, yellowBirdTexture, bigRedBirdTexture, vertical1Texture, vertical2Texture, vertical3Texture, horizontal1Texture, horizontal2Texture, horizontal3Texture, standTexture, slingShotTexture;
    ...
    public Level1Screen(final Main game) {
        this.game = game; this.paused = false; this.accumulator = 0;

        spriteBatch = new SpriteBatch();

        touchPos = new Vector2();
        backgroundTexture = new Texture("level1Background.png");
        redBirdTexture = new Texture("redBird.png");
        yellowBirdTexture = new Texture("yellowBird.png");
        bigRedBirdTexture = new Texture("bigRedBird.png");
        pigTexture = new Texture("regularPig.png");
        vertical1Texture = new Texture("vertical1.png");
        vertical2Texture = new Texture("vertical2.png");
        vertical3Texture = new Texture("vertical3.png");
        horizontal1Texture = new Texture("horizontal1.png");
        horizontal2Texture = new Texture("horizontal2.png");
        horizontal3Texture = new Texture("horizontal3.png");
        standTexture = new Texture("stand1.png");
        slingShotTexture = new Texture("slingShot.png");

        pauseTexture = new Texture("pause.png");
        retryTexture = new Texture("retry.png");

        start = new Vector2(423, 343);

        world = new World(new Vector2(0, -240), true);
        ground = new Ground(world, 0, 0, 1600, 193);
        stand = new Stand(world, 1215, 193, 317, 43);
        slingShot = new SlingShot(game, start, 85, 178, 375, 193);
        ...
        birds = new ArrayList<>();
        RedBird redBird = new RedBird(world, redBirdTexture, 0, 45, 45, 423, 343, 0, vector2, 0, 1);
        YellowBird yellowBird = new YellowBird(world, yellowBirdTexture, 1, 38, 38, 288, 193, 0, vector2, 0, 1);
        BigRedBird bigRedBird = new BigRedBird(world, bigRedBirdTexture, 2, 60, 60, 223, 193, 0, vector2, 0, 1);
        birds.add(redBird); birds.add(yellowBird); birds.add(bigRedBird);

        obstacles = new ArrayList<>();
        WoodObstacle vertical1, vertical2, vertical3, vertical4, vertical5, vertical6, vertical7, horizontal1, horizontal2, horizontal3, horizontal4, horizontal5;
        GlassObstacle vertical8, vertical9;
        vertical1 = new WoodObstacle(world, vertical1Texture, 21, 39, 1221, 230, 0, vector2,  0, 1);
        vertical2 = new WoodObstacle(world, vertical2Texture, 18, 147, 1301, 235,  0, vector2, 0, 1);
        vertical3 = new WoodObstacle(world, vertical2Texture, 18, 147, 1429, 235,  0, vector2, 0, 1);
        vertical4 = new WoodObstacle(world, vertical1Texture, 21, 39, 1508, 235,  0, vector2, 0, 1);
        vertical5 = new WoodObstacle(world, vertical2Texture, 18, 147, 1335, 394,  0, vector2, 0, 1);
        vertical6 = new WoodObstacle(world, vertical2Texture, 18, 147, 1403, 394,  0, vector2, 0, 1);
        vertical7 = new WoodObstacle(world, vertical1Texture, 21, 39, 1370, 553,  0, vector2, 0, 1);
        vertical8 = new GlassObstacle(world, vertical3Texture, 20, 74, 1341, 253,  0, vector2, 0, 1);
        vertical9 = new GlassObstacle(world, vertical3Texture, 20, 74, 1392, 253,  0, vector2, 0, 1);

        horizontal1 = new WoodObstacle(world, horizontal2Texture, 76, 20, 1336, 230,  0, vector2, 0, 1);
        horizontal2 = new WoodObstacle(world, horizontal2Texture, 76, 20, 1336, 322,  0, vector2, 0, 1);
        horizontal3 = new WoodObstacle(world, horizontal3Texture, 151, 20, 1300, 375,  0, vector2, 0, 1);
        horizontal4 = new WoodObstacle(world, horizontal1Texture, 38, 20, 1356, 394,  0, vector2, 0, 1);
        horizontal5 = new WoodObstacle(world, horizontal2Texture, 76, 20, 1341, 536,  0, vector2, 0, 1);
        ...
        pigs = new ArrayList<>();
        RegularPig pig1;
        pig1 = new RegularPig(world, pigTexture, 40, 40, 1376, 444, 0, vector2, 0, 3);
        pigs.add(pig1);
    ...
    public Level1Screen(final Main game, Serialisation serialise) {
        this.game = game; this.paused = false; this.accumulator = 0;
        ...
        pigTexture = new Texture("regularPig.png");
        vertical1Texture = new Texture("vertical1.png");
        vertical2Texture = new Texture("vertical2Wood.png");
        vertical3Texture = new Texture("vertical3.png");
        horizontal1Texture = new Texture("horizontal1.png");
        horizontal2Texture = new Texture("horizontal2.png");
        horizontal3Texture = new Texture("horizontal3.png");
        ...
        if (Gdx.input.isTouched()) {
            ...
            if (game.getTimer() > 0.1f) {
                if (retryButton.contains(touchPos.x, touchPos.y)) {
                    ...
                    game.setTimer(0);
                    game.setScreen(new PauseScreen(game, 1, this));
                    dispose();
    ...
    private void draw() {
        ...
        game.batch.draw(standTexture, 1215, 193, 317, 43);
        game.batch.draw(slingShotTexture, 375, 193, 85, 178);
        slingShot.draw();
    ...
    public void save() {
        ...
        try (FileWriter writer = new FileWriter(Constants.filepath1)) {
